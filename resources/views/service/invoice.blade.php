    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 mt-16">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-200 overflow-hidden" id="invoice-content">
                                ...
                                <div class="space-y-3">
                                    ...
                                    @if($transaksi->diskon > 0)
                                        <div class="flex justify-between text-sm sm:text-lg">
                                            ...
                                            <span class="font-semibold">Rp{{ number_format($transaksi->total_barang + $transaksi->total_jasa, 0, ',', '.') }}</span>
                                        </div>
                                        <div class="flex justify-between text-sm sm:text-lg">
                                            <span class="text-gray-600">Diskon ({{ $transaksi->tipe_diskon == 'persentase' ? $transaksi->diskon.'%' : 'Rp'.number_format($transaksi->diskon, 0, ',', '.') }}):</span>
                                            <span class="font-semibold text-red-600">-Rp{{ number_format(
                ...
                <!-- Footer -->
                <div class="mt-8 mb-8 pt-6 border-t border-gray-200 text-center text-gray-500 text-sm sm:text-base">
