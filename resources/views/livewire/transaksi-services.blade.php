                    ...
                    <div>
                       ...
                       <div class="w-full max-w-xs">
                            ...
                            <div class="relative flex items-center group">
                                <div class="absolute left-3 text-gray-400 group-focus-within:text-blue-500 transition-colors pointer-events-none">
                                ...
                                <input wire:model="tanggal_service" 
                                    id="tanggal-service"
                                    type="date"
                                    class="w-full text-gray-700 font-semibold text-sm bg-white border border-gray-200 rounded-xl pl-10 pr-16 py-2.5 shadow-sm transition-all focus:ring-4 focus:ring-blue-100 focus:border-blue-500 focus:outline-none cursor-pointer hover:border-gray-300"
                                    style="color-scheme: light;">

                                <div class="absolute right-3 bg-gray-100 text-gray-500 font-bold text-[10px] tracking-wider px-2 py-1 rounded-md uppercase pointer-events-none select-none border border-gray-200">
                                    WITA
                                </div>
                            </div>
                        </div>
